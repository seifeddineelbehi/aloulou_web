                        ...
                        return(
                            <div key={index} className="group relative lg:px-6 mt-4 rounded-xl overflow-hidden text-center">
                                <div className="relative overflow-hidden text-transparent -m-3">
                                    <Hexagon className="h-28 w-28 fill-[#FF6F61]/5 mx-auto rotate-[30deg]"
                                    ></Hexagon>
                                    <div className="absolute top-2/4 -translate-y-2/4 start-0 end-0 mx-auto text-[#FF6F61] rounded-xl text-3xl flex align-middle justify-center items-center">
                                        <Icon width={30} height={30}/>
                                    </div>
                                </div>
                                <div className="mt-6">
                                    <Link href="/features" className="font- text-lg h5 hover:text-[#FF6F61] font-lexend" >
                                        {item.title}
                                    </Link>
