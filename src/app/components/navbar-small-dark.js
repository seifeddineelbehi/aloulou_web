            ...
            <nav className={`${navbarTop === true ? 'is-sticky' : ''} navbar font-lexend `}id="navbar">
                <div className="container flex flex-wrap items-center justify-end">
                     <a className="navbar-brand md:me-8" href="/">
                        <Image src="/images/aloulou-light.png" className="inline-block dark:hidden" alt="" width={113} height={28}/>
                        <Image src="/images/aloulou-light.png" className="hidden dark:inline-block" alt="" width={113} height={28}/>
                    </a>
                    ...
                    <div className="nav-icons flex items-center lg_992:order-2 ms-auto lg:ms-4">
                        ...
                        <ul className="list-none menu-social mb-0">
                            <li className="inline">
                                <Link href="/login" 
                                    className="h-9 w-9 inline-flex items-center text-center justify-center text-base font-normal tracking-wide border align-middle transition duration-500 ease-in-out rounded-full bg-[#FF6F61] hover:bg-[#E55A4F] border-[#FF6F61] hover:border-[#E55A4F] text-white"><Unicons.UilUser width={16}/></Link>
                            </li>
                        </ul>
